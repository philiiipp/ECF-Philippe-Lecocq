        ...
        <div class="form-container">
            ...
            <form method="post" action="insertion.php">
                <div class="form-layout">
                    ...
                    <div class="form-row">
                        <label for="nombre-de-convives">Nombre de convive par défaut :</label></br>
                        <input type="number" id="nombre-de-convives" name="nombre-de-convives" min="1" max="8">
                    </div>
                    <div class="form-row">
                        <label for="allergies">Allergies :</label></br>
                        <input class="form-grey-bar"type="text" id="allergies" name="allergies" placeholder="Spécifiez vos allergies">
                    </div>
                </div>
